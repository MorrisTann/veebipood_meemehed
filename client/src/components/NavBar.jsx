  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center relative">
        <div className="text-3xl font-bold text-gray-700 hover:text-amber-600 transition px-2 py-1">
          <Link 
          to="/">Avaleht</Link>
        </div>
        ...
        <div className="lg:hidden">
          <button
            className="text-gray-700 focus:outline-none hover:text-amber-600 transition px-2 py-1"
            onClick={toggleMenu}
          >
        ...
        <div className="hidden lg:flex lg:items-center lg:space-x-6 text-gray-700">
          {navLinks(user, totalItems)}
        </div>
      </div>
    </nav>
...
const navLinks = (user, totalItems) => (
  <>
    <Link to="/tooted" className="font-bold hover:text-amber-600 transition px-2 py-1">Tooted</Link>
    <Link to="/meist" className="font-bold hover:text-amber-600 transition px-2 py-1">Meist</Link>
    <Link to="/kontaktid" className="font-bold hover:text-amber-600 transition px-2 py-1">Kontaktid</Link>
    {user ? (
